            ...
            <div v-if="isHovering">
                ...
                <div class="time-left-controls">
                    ...
                    <div class="input-control">
                        ...
                        <div class="input-control-value">
                            <input type="number" min="0" max="24" v-model="hours" placeholder="Hours"
                                @change="updateStart()" />
                            <span>:</span>
                        </div>
                    </div>
                    <div class="input-control">
                        ...
                        <div class="input-control-value">
                            <input type="number" min="0" max="60" v-model="minutes" placeholder="Minutes"
                                @change="updateStart()" />
                            <span>:</span>
                        </div>
                    </div>
                    <div class="input-control">
                        ...
                        <input type="number" min="0" max="60" v-model="seconds" placeholder="Seconds"
                            @change="updateStart()" />
                    </div>
                </div>
            </div>
            ...
            <transition name="fadeHeight" mode="out-in">
                <div v-if="isHovering" class="options">
                    <template v-if="isPaused">
                        <button @click="start" class="options-button" :class="{ disabled: timeIsEmpty }"
                            :disabled="timeIsEmpty">
                            &#9654;<br />Start
                        </button>
                    </template>
                    <template v-else>
